...
#define UNKNOWNECHOCRYPTOMODULE_ALLOC_H
 ...
 */
#define uecm_check_alloc_or_goto(var, label) \
	if (errno == ENOMEM) { \
        ei_stacktrace_push_errno() \
        uecm_safe_free(var) \
        goto label; \
